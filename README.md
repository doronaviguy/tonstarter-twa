...
2. Create a new bot with [botfather](https://t.me/botfather)
   ...
   4. Run `./configure_bot.sh [ACCESS_TOKEN] https://[YOUR-GITHUB-USERNAME].github.io/[YOUR-REPO-NAME]/`
   
3. You're all set! Go to https://t.me/[YOUR-TELEGRAM-BOT-USERNAME] and press the launch button
